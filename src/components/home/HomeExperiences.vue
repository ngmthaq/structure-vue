<template>
  <div id="experiences" @mousemove="app.onOver">
    <div class="resume-cont">
      <v-container>
        <v-row>
          <v-col cols="12">
            <div class="title-cont">
              <div class="title-background">experiences</div>
        ...
        <v-row>
          <v-col cols="12">
            <p class="text-center px-5 text-white">
              My résumé includes my learning process in university and my working experiences. I have a little bit of working experiences and I need your
              company to grow it up
            </p>
          </v-col>
        </v-row>
        <v-row class="mt-5">
      ...
      timelines: [
        ...
        },
        {
          company: {
            ...
            image: LogoBGlobal,
            url: `https://bglobalcorp.com/`,
            description: `This is a website and PWA aiming to provide a new way to find a job. 
            Adapting PWA technology for quick and easy to go through the job listings, working for PC and mobile devices. 
            The functions of the application are filtering jobs, saving and deleting jobs that are not suitable, viewing job details, 
